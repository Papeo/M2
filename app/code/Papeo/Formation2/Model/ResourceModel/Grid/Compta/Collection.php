...
namespace Papeo\Formation2\Model\ResourceModel\Grid\Compta;
...
class Collection extends SearchResult
{
    ...
    public function _initSelect()
    {
       ...
       $this->getSelect()->joinLeft(['fourthTable'=> $this->getTable('sales_order_tax')],'main_table.entity_id= fourthTable.order_id');
